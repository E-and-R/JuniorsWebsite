    ...
    return(
        <ThemeProvider theme={Theme}>
            <form method="POST" action="https://formspree.io/f/xoqprrvd" >
                ...
                <TextField variant="filled" label="Project details" color='primary' className={classes.root} InputProps={{className: classes.input}} InputLabelProps={{className: classes.input}} FormHelperTextProps={{className: classes.input}} style={{width:'80%'}} placeholder="Type your projeect details here...." type="text" multiline style={{width:'80%'}}  rows={4}  name="Message" inputRef={register({required: true})}/><br/>
